...
pushd ..
cp -a batchtools buildavx2
popd
pushd ..
cp -a batchtools buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737132943
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/batchtools/libs/batchtools.so
/V4/usr/lib64/R/library/batchtools/libs/batchtools.so
